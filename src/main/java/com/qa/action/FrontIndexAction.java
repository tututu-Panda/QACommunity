...
public class FrontIndexAction extends BaseAction{
    ...
    private List replyInfo = null;

    private List quesInfo = null;
    ...
    public String getQuestionIndex() {
        ...
        quesList = frontIndexService.getQuesIndex(page,orderType,topic);
    ...
    public String weekRank(){
        replyInfo = frontIndexService.getReplyRank();
        return "replyRank";
    }
    ...
    public List getReplyInfo() {
        return replyInfo;
    }

    public void setReplyInfo(List replyInfo) {
        this.replyInfo = replyInfo;
    }

    public List getQuesInfo() {
        return quesInfo;
    }

    public void setQuesInfo(List quesInfo) {
