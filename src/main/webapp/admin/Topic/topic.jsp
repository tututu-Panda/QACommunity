...
<s:iterator value="list" status="st" var="b">
            ...
            <tr>
                ...
                <%--<td><a data=${b.toId}" class="layui-btn layui-btn-normal "> 删除 </a></td>--%>
                <td><button class="layui-btn layui-btn-normal " onclick="deleteTopic(${b.toId})">删除</button></td>
               ...
               <th> <button class="layui-btn layui-btn-normal " onclick="updateTopic(${b.toId})">修改</button><th>
                ...
                <script type="text/javascript">
                    ...
                    function deleteTopic(id) {
                        layer.confirm('确定删除该话题?', {
                            btn: ['确定', '取消']
                        }, function () {
                            console.log(id);
                            //ajax
                            $.ajax({
                            url: "<%=basePath %>/admin/qaBackTopic_DeleteTopic.action",
                            type:"POST",
                            data:{
                            'id': id
                            },
